    ...
    <footer className="bg-gray-700 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          {/* Quick Links */}
          <div className="md:col-span-1">
            <h3 className="text-base font-medium text-white mb-1">Quick Links</h3>
          ...
          {/* Job Seekers */}
          <div className="md:col-span-1">
            <h3 className="text-base font-medium text-white mb-1">Job Seekers</h3>
            <ul className="space-y-0.5">
              <li><Link to="/profile/create" className="text-sm text-gray-400 hover:text-white transition-colors">Create Profile</Link></li>
              <li><Link to="/jobs/search" className="text-sm text-gray-400 hover:text-white transition-colors">Job Search</Link></li>
              <li><Link to="/resources/career" className="text-sm text-gray-400 hover:text-white transition-colors">Career Resources</Link></li>
              <li><Link to="/resume-tips" className="text-sm text-gray-400 hover:text-white transition-colors">Resume Tips</Link></li>
          ...
          {/* Employers */}
          <div className="md:col-span-1">
            <h3 className="text-base font-medium text-white mb-1">Employers</h3>
            <ul className="space-y-0.5">
              <li><Link to="/jobs/post" className="text-sm text-gray-400 hover:text-white transition-colors">Post a Job</Link></li>
              <li><Link to="/employers/profile" className="text-sm text-gray-400 hover:text-white transition-colors">Create Company Profile</Link></li>
              <li><Link to="/resumes/browse" className="text-sm text-gray-400 hover:text-white transition-colors">Browse Resumes</Link></li>
              <li><Link to="/pricing" className="text-sm text-gray-400 hover:text-white transition-colors">Pricing Plans</Link></li>
              <li><Link to="/resources/employer" className="text-sm text-gray-400 hover:text-white transition-colors">Employer Resources</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center">
          <p className="text-sm text-gray-500 mb-2 md:mb-0">© {new Date().getFullYear()} FutureLift. All rights reserved.</p>
