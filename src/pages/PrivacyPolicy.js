      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-600">
          <section className="mb-8">
            ...
            <p>
              FutureLift ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
            </p>
            <p>
          ...
          <section className="mb-8">
            ...
            <p>
              When you register on our platform, apply for jobs, or submit your resume, we collect personally identifiable information, such as:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>Your name, email address, phone number, and physical address</li>
              <li>Employment history, educational background, and skills</li>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>Time spent on specific pages and overall time on the website</li>
              <li>Referral sources and pages accessed before and after visiting our site</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">With Employers and Recruiters</h3>
            <p>
              If you are a job seeker, we will share your profile information, resume, and other job-related data with employers and recruiters who may be interested in your qualifications.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>The right to restrict certain processing of your personal information</li>
            </ul>
            <p>
              To exercise these rights, please contact us at privacy@futurelift.com.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-2">
              <p>Email: privacy@futurelift.com</p>
