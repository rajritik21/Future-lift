...
const Todo = ({ user }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
      <h2 className="text-xl font-semibold text-gray-800 mb-6">Job Application Tasks</h2>
      ...
      <ul className="space-y-2">
        {filteredTodos.length === 0 ? (
          ...
          filteredTodos.map((todo) => (
            <li
              key={todo.id}
              className="flex items-center justify-between bg-gray-50 p-3 rounded-md hover:bg-gray-100 transition-colors duration-200"
            >
